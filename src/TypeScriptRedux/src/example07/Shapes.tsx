...
class ShapeMakerBase extends React.Component<any, any> {
...
class ShapeViewerBase extends React.Component<any, any> {
    constructor(props?, context?) {
        super(props, context);
